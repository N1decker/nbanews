...
import ru.nidecker.nbanews.advice.AuthenticationFailureHandler;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/api/news/**", "/news/**", "/profile/**").authenticated()
                .antMatchers(HttpMethod.DELETE, "/api/news/**").hasRole("EDITOR")
                .antMatchers(HttpMethod.POST, "/news/**").hasRole("EDITOR")
